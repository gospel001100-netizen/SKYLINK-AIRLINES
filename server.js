...
// ===== FINAL SKYLINK LOGISTICS DHL - RECEIPT THEN TRACKING FLOW =====
...
app.post('/api/logistics/book', async (req,res)=>{
  try{
    ...
    res.json({receiptUrl:'/logistics-receipt?code='+code, trackingUrl:'/logistics-track?code='+code});
...
app.get('/logistics-receipt', async (req,res)=>{
  try{
    ...
    if(!r.rows.length) return res.send('<h3 style="font-family:Arial;text-align:center;margin-top:40px">Receipt not found<br><a href="/logistics">Create new</a></h3>');
